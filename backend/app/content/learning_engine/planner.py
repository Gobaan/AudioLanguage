...
def adaptive_learning_plan_from_session(
    ...
    *,
    ...
    indexed = adaptive_indexed_lessons(session, scene_set=scene_set, order_seed=order_seed)
...
def adaptive_indexed_lessons(
    ...
    *,
    ...
    indexed = indexed_lessons(session, scene_set=scene_set, order_seed=order_seed)
    if scene_set not in {"delayed", "delayed_review"}:
        indexed.extend(indexed_lessons(session, scene_set="delayed", order_seed=order_seed))
    return indexed
