...
class LessonsApiTests(unittest.TestCase):
    ...
    def test_language_selection_routes_and_new_languages_load(self):
        ...
        home_response = client.get("/gobi-home")
        root_response = client.get("/")
        old_languages_response = client.get("/languages")
        ...
        self.assertEqual(old_languages_response.status_code, 404)
        ...
        ar = next(item for item in languages if item["id"] == "ar")
        ...
        self.assertEqual(ar["display_name"], "Arabic")
        self.assertEqual(ar["description"], "Arabic starter and transfer scenes.")
        self.assertEqual(ar["scene_sets"], ["mvp", "delayed"])
        ...
        self.assertEqual(ar["sort_order"], 3)
        self.assertEqual([item["id"] for item in languages], ["ja", "yue", "ar", "zh", "ta", "en"])
